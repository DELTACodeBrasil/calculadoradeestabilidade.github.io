...
async function gerarPDF() {
    ...
    doc.text('NASA Style Stability Analyzer', 20, 38);
    ...
    doc.text('Sistema desenvolvido para a Mostra Brasileira de Foguetes (OBA)', 20, y + 18);
    doc.text('© 2026 Δ.DΣLTA CODE BRASIL', 20, y + 28);

    doc.save('Relatorio_Estabilidade_OBA.pdf');
}
